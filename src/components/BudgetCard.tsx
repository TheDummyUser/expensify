...
const BudgetCard: React.FC<BudgetCardProps> = ({ monthYear, budget, spent, onPress }) => {
	...
	return (
		<View style={[styles.cardContainer, { justifyContent: "space-between" }]}>
			...
			<Pressable onLongPress={onPress} delayLongPress={500} style={{ justifyContent: "center", alignContent: "center", alignItems: "center", height: "60%" }} >
			...
			<View style={styles.cardHeader}>
				...
				<View style={[styles.cardHeader, { gap: 10, alignItems: "center" }]}>
					<Text style={[styles.txt, styles.down]}>
						₹ {spent}/...
					</Text>
